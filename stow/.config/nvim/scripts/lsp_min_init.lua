...
local neodev_path = join_paths(package_root, "test", "start", "neodev")
if vim.fn.isdirectory(neodev_path) ~= 1 then
  vim.fn.system { "git", "clone", "https://github.com/folke/neodev.nvim", neodev_path }
end
